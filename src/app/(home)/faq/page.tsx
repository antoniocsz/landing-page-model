...
export default function ContactUs() {
  return (
    <div className="container w-full h-full flex flex-col text-white p-4 pb-8 lg:py-18 lg:px-20">
          ...
          <section className="container h-full items-center flex flex-col text-zinc-300 body-font gap-16 py-16 px-4">
            <div className="flex flex-col items-center  text-center gap-4">
              ...
              <p className="font-light text-xs">
                As perguntas mais comuns que as pessoas tem sobre o nosso
                sistema.
              </p>
            </div>
            ...
            <Accordion className="w-full" type="single" collapsible>
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  Para começar, faça o download do aplicativo na loja de
                  aplicativos do seu dispositivo. Depois de instalar, crie uma
                  conta e siga as instruções para inserir suas informações
                  financeiras básicas, como renda mensal, despesas fixas e
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  Nosso aplicativo oferece recursos como rastreamento de
                  despesas, orçamento mensal personalizável e alertas de gastos
                  excessivos. Além disso, fornecemos insights e sugestões
                  personalizadas com base em seus hábitos de gastos para
                  ajudá-lo a identificar áreas onde você pode economizar e
          ...
          <AccordionContent>
            ...
            mercado financeiro para tomar decisões informadas.
              ...
              <AccordionItem value="item-5">
                <AccordionTrigger>
                  Como posso entrar em contato com o suporte ao cliente em caso
                  de dúvidas ou problemas?
                </AccordionTrigger>
                <AccordionContent>
                  Estamos aqui para ajudar! Você pode entrar em contato com
                  nossa equipe de suporte ao cliente diretamente pelo
                  aplicativo, enviando uma mensagem através da seção de suporte.
                  Nossa equipe está disponível para responder suas perguntas,
                  fornecer assistência técnica e oferecer orientação
                  personalizada para ajudá-lo a aproveitar ao máximo nosso
